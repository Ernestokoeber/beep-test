...
function injectStyles() {
  ...
  style.textContent = `
    ...
    .cha-player{position:relative;width:100%;min-height:100dvh;padding-bottom:var(--courthub-safe-bottom,env(safe-area-inset-bottom,0px));overflow:hidden;background:#fff;color:#282321}.cha-head{display:flex;align-items:center;justify-content:space-between;gap:1rem;height:calc(3.5rem + var(--courthub-safe-top,env(safe-area-inset-top,0px)));padding:var(--courthub-safe-top,env(safe-area-inset-top,0px)) max(1.4rem,var(--courthub-safe-right,env(safe-area-inset-right,0px))) 0 max(1.4rem,var(--courthub-safe-left,env(safe-area-inset-left,0px)));border-bottom:1px solid #eceeef}.cha-head>div{display:flex;align-items:center;gap:.5rem}.cha-head .chq-kicker{display:none}.cha-head h2{margin:0;font-size:.9rem;font-weight:550}.cha-head .chq-btn{display:grid;place-items:center;width:2.5rem;height:2.5rem;border:0;border-radius:.3rem;background:transparent;font-size:1.2rem;cursor:pointer}.cha-head .chq-btn:hover{background:#f4f5f5}
    .cha-court{display:grid;place-items:center;min-height:calc(100dvh - 3.5rem - var(--courthub-safe-top,env(safe-area-inset-top,0px)));padding:1rem max(1rem,var(--courthub-safe-right,env(safe-area-inset-right,0px))) 6.5rem max(1rem,var(--courthub-safe-left,env(safe-area-inset-left,0px)))}.cha-court svg{display:block;width:min(54rem,calc((100dvh - 8rem) * 1.1515),100%);height:auto;border-radius:.35rem;box-shadow:0 .5rem 1.8rem rgba(74,52,37,.12)}
    .cha-controls{position:fixed;z-index:5;left:max(1rem,var(--courthub-safe-left,env(safe-area-inset-left,0px)));right:max(1rem,var(--courthub-safe-right,env(safe-area-inset-right,0px)));bottom:calc(1rem + var(--courthub-safe-bottom,env(safe-area-inset-bottom,0px)));display:grid;grid-template-columns:auto minmax(12rem,1fr) auto;gap:.75rem;align-items:center;width:auto;max-width:45rem;margin-inline:auto;padding:.55rem .75rem;border:1px solid #eceeef;border-radius:.75rem;background:rgba(255,255,255,.96);box-shadow:0 .6rem 1.8rem rgba(28,35,39,.14);backdrop-filter:blur(.6rem)}.cha-buttons,.cha-speeds{display:flex;align-items:center;gap:.3rem}.cha-buttons .chq-btn,.cha-speeds .chq-btn{min-height:2.35rem;padding:.35rem .55rem;border:1px solid transparent;border-radius:.35rem;background:transparent;color:#505a60;font-size:.68rem;cursor:pointer}.cha-buttons .primary{display:grid;place-items:center;width:2.7rem;height:2.7rem;padding:0;border-radius:50%;background:#111;color:#fff;font-size:1rem}.cha-progress-wrap{display:grid;gap:.2rem}.cha-time{display:flex;justify-content:space-between;color:#989da0;font-size:.58rem}.cha-track{position:relative}.cha-track input{width:100%;accent-color:#25323a}.cha-markers{position:absolute;inset:50% .5rem auto;pointer-events:none}.cha-marker{position:absolute;width:2px;height:.55rem;transform:translate(-1px,-50%);background:#9aa0a4;border-radius:2px;opacity:.65}.cha-speeds button.active{border-color:#dfe2e3;background:#f5f6f6;color:#222}.cha-player[data-reduced-motion="true"] .cha-marker{transition:none}
    @media(max-width:680px){.cha-head{padding-top:var(--courthub-safe-top,env(safe-area-inset-top,0px));padding-right:max(.55rem,var(--courthub-safe-right,env(safe-area-inset-right,0px)));padding-left:max(.55rem,var(--courthub-safe-left,env(safe-area-inset-left,0px)))}.cha-court{min-height:0;padding:.5rem max(.4rem,var(--courthub-safe-right,env(safe-area-inset-right,0px))) 7rem max(.4rem,var(--courthub-safe-left,env(safe-area-inset-left,0px)))}.cha-court svg{width:100%}.cha-controls{left:max(.6rem,var(--courthub-safe-left,env(safe-area-inset-left,0px)));right:max(.6rem,var(--courthub-safe-right,env(safe-area-inset-right,0px)));grid-template-columns:auto minmax(8rem,1fr);bottom:calc(.6rem + var(--courthub-safe-bottom,env(safe-area-inset-bottom,0px)));padding:.5rem}.cha-speeds{grid-column:1/-1;justify-content:center}.cha-controls button{min-height:44px}}
  `;
