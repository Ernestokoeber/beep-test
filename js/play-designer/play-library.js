...
export function createPlayLibrary(options = {}) {
  ...
  root.innerHTML = `
    <div class="chl-library-head"><button class="chl-new-play" type="button" data-action="create-play"><span aria-hidden="true">＋</span> Neues Play</button></div>
